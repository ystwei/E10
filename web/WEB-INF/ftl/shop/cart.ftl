...
<table border="0" width="100%" cellspacing="0" cellpadding="0">
	<tr>
		...
		<td valign="top" align="center">
				...
				<#if Request["clist"]?exists>
					...
					<tr bgcolor="#FFFF88">
								...
								<td>
									...
									<input type="hidden" name="dlist" value="${cart.itemid}"/>
									<input type="hidden" name="olist" value="${cart.orderid}"/>
									<#assign oid="${cart.orderid}"?number> 	
									<input type="hidden" name="oid" value="${cart.orderid}"/>
									</b>
								</td>
			...
			<br />
			<center>
				<a href="${ppath}/cart/check/oid/${oid}"><img border="0"
